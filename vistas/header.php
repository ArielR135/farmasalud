    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>FarmaSalud</b></span>
        </a>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      www.21.edu.ar - FarmaSalud
                      <small>www.youtube.com/user/uesiglo21</small>
                    </p>
                  </li>
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="#">
                ...
                <small class="label pull-right bg-yellow">FS</small>
              </a>
            </li>
